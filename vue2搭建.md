...
7. iview css框架
8. sublimeText格式化插件：HTML/CSS/JS Prettify安装后 tools->HTML/CSS/JS Prettify->set prettify preference：在"allowed_file_extensions": ["htm", "html", "xhtml", "shtml", "xml", "svg","vue"] 加上vue就好了
...
```
3. 按需引用  import Checkbox from 'iview/src/components/checkbox';
...
7. iView Loader 统一 iView 标签书写规范
